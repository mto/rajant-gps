 ...
 * @date: 2/20/17
 */
public class GPSMessageEncoder extends MessageToMessageEncoder<GpsProtos.GPS> {

    @Override
    protected void encode(ChannelHandlerContext ctx, GpsProtos.GPS msg, List<Object> out) throws Exception {
